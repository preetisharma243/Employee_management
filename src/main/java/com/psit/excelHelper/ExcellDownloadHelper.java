...
public class ExcellDownloadHelper {
	 public static String TYPE = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
	  static String[] HEADERs = { "Id", "FristName", "LastName", "Email","MobileNo","salary","status","failedReason"};
	  static String SHEET = "Emp";

	  public static ByteArrayInputStream createEmployeeToExcel(List<Employee> employeeList) {
	    ...
	    try (Workbook workbook = new XSSFWorkbook(); ByteArrayOutputStream out = new ByteArrayOutputStream();) {
	      ...
	      for (Employee employee : employeeList) {
	        ...
	        row.createCell(7).setCellValue(employee.getFailedReason());
